 ...
 */
function o(e,t){function n(n){return t.disableLogs||console.log("RecordRTC version: ",y.version),n&&(t=new a(e,n)),t.disableLogs||console.log("started recording "+t.type+" stream."),v?(v.clearRecordedData(),v.record(),g("recording"),y.recordingDuration&&m(),y):(i(function(){y.recordingDuration&&m()}),y)}function i(n){n&&(t.initCallback=function(){n(),n=t.initCallback=null});var i=new r(e,t);v=new i(e,t),v.record(),g("recording"),t.disableLogs||console.log("Initialized recorderType:",v.constructor.name,"for output-type:",t.type)}function d(e){function n(n){if(!v)return void("function"==typeof e.call?e.call(y,""):e(""));Object.keys(v).forEach(function(e){"function"!=typeof v[e]&&(y[e]=v[e])});var i=v.blob;if(!i){if(!n)throw"Recording failed.";v.blob=i=n}if(i&&!t.disableLogs&&console.log(i.type,"->",s(i.size)),e){var o;try{o=A.createObjectURL(i)}catch(e){}"function"==typeof e.call?e.call(y,o):e(o)}t.autoWriteToDisk&&p(function(e){var n={};n[t.type+"Blob"]=e,N.Store(n)})}return e=e||function(){},v?"paused"===y.state?(y.resumeRecording(),void setTimeout(function(){d(e)},1)):("recording"===y.state||t.disableLogs||console.warn('Recording state should be: "recording", however current state is: ',y.state),t.disableLogs||console.log("Stopped recording "+t.type+" stream."),"gif"!==t.type?v.stop(n):(v.stop(),n()),void g("stopped")):void h()}function u(){return v?"recording"!==y.state?void(t.disableLogs||console.warn("Unable to pause the recording. Recording state: ",y.state)):(g("paused"),v.pause(),void(t.disableLogs||console.log("Paused recording."))):void h()}function l(){return v?"paused"!==y.state?void(t.disableLogs||console.warn("Unable to resume the recording. Recording state: ",y.state)):(g("recording"),v.resume(),void(t.disableLogs||console.log("Resumed recording."))):void h()}function f(e){postMessage((new FileReaderSync).readAsDataURL(e))}function p(e,n){if(!e)throw"Pass a callback function over getDataURL.";var i=n?n.blob:(v||{}).blob;if(!i)return t.disableLogs||console.warn("Blob encoder did not finish its job yet."),void setTimeout(function(){p(e,n)},1e3);if("undefined"==typeof Worker||navigator.mozGetUserMedia){var o=new FileReader;o.readAsDataURL(i),o.onload=function(t){e(t.target.result)}}else{var a=function(e){try{var t=A.createObjectURL(new Blob([e.toString(),"this.onmessage =  function (eee) {"+e.name+"(eee.data);}"],{type:"application/javascript"})),n=new Worker(t);return A.revokeObjectURL(t),n}catch(e){}}(f);a.onmessage=function(t){e(t.data)},a.postMessage(i)}}function m(e){if(e=e||0,"paused"===y.state)return void setTimeout(function(){m(e)},1e3);if("stopped"!==y.state){if(e>=y.recordingDuration)return void d(y.onRecordingStopped);e+=1e3,setTimeout(function(){m(e)},1e3)}}function g(e){y&&(y.state=e,"function"==typeof y.onStateChanged.call?y.onStateChanged.call(y,e):y.onStateChanged(e))}function h(){!0!==t.disableLogs&&console.warn(b)}if(!e)throw"First parameter is required.";t=t||{type:"video"},t=new a(e,t);var v,y=this,b='It seems that recorder is destroyed or "startRecording" is not invoked for '+t.type+" recorder.",w={startRecording:n,stopRecording:d,pauseRecording:u,resumeRecording:l,initRecorder:i,setRecordingDuration:function(e,t){if(void 0===e)throw"recordingDuration is required.";if("number"!=typeof e)throw"recordingDuration must be a number.";return y.recordingDuration=e,y.onRecordingStopped=t||function(){},{onRecordingStopped:function(e){y.onRecordingStopped=e}}},clearRecordedData:function(){if(!v)return void h();v.clearRecordedData(),t.disableLogs||console.log("Cleared old recorded data.")},getBlob:function(){return v?v.blob:void h()},getDataURL:p,toURL:function(){return v?A.createObjectURL(v.blob):void h()},getInternalRecorder:function(){return v},save:function(e){if(!v)return void h();c(v.blob,e)},getFromDisk:function(e){if(!v)return void h();o.getFromDisk(t.type,e)},setAdvertisementArray:function(e){t.advertisement=[];for(var n=e.length,i=0;i<n;i++)t.advertisement.push({duration:i,image:e[i]})},blob:null,bufferSize:0,sampleRate:0,buffer:null,reset:function(){"recording"!==y.state||t.disableLogs||console.warn("Stop an active recorder."),v&&"function"==typeof v.clearRecordedData&&v.clearRecordedData(),v=null,g("inactive"),y.blob=null},onStateChanged:function(e){t.disableLogs||console.log("Recorder state changed:",e)},state:"inactive",getState:function(){return y.state},destroy:function(){var e=t.disableLogs;t={disableLogs:!0},y.reset(),g("destroyed"),w=y=null,E.AudioContextConstructor&&(E.AudioContextConstructor.close(),E.AudioContextConstructor=null),t.disableLogs=e,t.disableLogs||console.log("RecordRTC is destroyed.")},version:"5.5.9"};if(!this)return y=w,w;for(var C in w)this[C]=w[C];return y=this,w}/**
 ...
 */
function a(e,t){return t.recorderType||t.type||(t.audio&&t.video?t.type="video":t.audio&&!t.video&&(t.type="audio")),t.recorderType&&!t.type&&(t.recorderType===y||t.recorderType===v||void 0!==k&&t.recorderType===k?t.type="video":t.recorderType===b?t.type="gif":t.recorderType===h?t.type="audio":t.recorderType===g&&(l(e,"audio").length&&l(e,"video").length?t.type="video":!l(e,"audio").length&&l(e,"video").length?t.type="video":l(e,"audio").length&&!l(e,"video").length&&(t.type="audio"))),void 0!==g&&"undefined"!=typeof MediaRecorder&&"requestData"in MediaRecorder.prototype&&(t.mimeType||(t.mimeType="video/webm"),t.type||(t.type=t.mimeType.split("/")[0]),t.bitsPerSecond),t.type||(t.mimeType&&(t.type=t.mimeType.split("/")[0]),t.type||(t.type="audio")),t}/**
 ...
 */
function h(e,t){function n(){if(!1===t.checkForInactiveTracks)return!0;if("active"in e){if(!e.active)return!1}else if("ended"in e&&e.ended)return!1;return!0}function i(e,t){function n(e,t){function n(e,t,n){var o=Math.round(e.length*(t/n)),a=[],r=Number((e.length-1)/(o-1));a[0]=e[0];for(var d=1;d<o-1;d++){var s=d*r,c=Number(Math.floor(s)).toFixed(),u=Number(Math.ceil(s)).toFixed(),l=s-c;a[d]=i(e[c],e[u],l)}return a[o-1]=e[e.length-1],a}function i(e,t,n){return e+(t-e)*n}function o(e,t){for(var n=new Float64Array(t),i=0,o=e.length,a=0;a<o;a++){var r=e[a];n.set(r,i),i+=r.length}return n}function a(e,t,n){for(var i=n.length,o=0;o<i;o++)e.setUint8(t+o,n.charCodeAt(o))}var r=e.numberOfAudioChannels,d=e.leftBuffers.slice(0),s=e.rightBuffers.slice(0),c=e.sampleRate,u=e.internalInterleavedLength,l=e.desiredSampRate;2===r&&(d=o(d,u),s=o(s,u),l&&(d=n(d,l,c),s=n(s,l,c))),1===r&&(d=o(d,u),l&&(d=n(d,l,c))),l&&(c=l);var f;2===r&&(f=function(e,t){for(var n=e.length+t.length,i=new Float64Array(n),o=0,a=0;a<n;)i[a++]=e[o],i[a++]=t[o],o++;return i}(d,s)),1===r&&(f=d);var p=f.length,m=44+2*p,g=new ArrayBuffer(m),h=new DataView(g);a(h,0,"RIFF"),h.setUint32(4,36+2*p,!0),a(h,8,"WAVE"),a(h,12,"fmt "),h.setUint32(16,16,!0),h.setUint16(20,1,!0),h.setUint16(22,r,!0),h.setUint32(24,c,!0),h.setUint32(28,2*c,!0),h.setUint16(32,2*r,!0),h.setUint16(34,16,!0),a(h,36,"data"),h.setUint32(40,2*p,!0);for(var v=p,y=44,b=0;b<v;b++)h.setInt16(y,32767*f[b],!0),y+=2;if(t)return t({buffer:g,view:h});postMessage({buffer:g,view:h})}if(e.noWorker)return void n(e,function(e){t(e.buffer,e.view)});var i=a(n);i.onmessage=function(e){t(e.data.buffer,e.data.view),A.revokeObjectURL(i.workerURL),i.terminate()},i.postMessage(e)}function a(e){var t=A.createObjectURL(new Blob([e.toString(),";this.onmessage =  function (eee) {"+e.name+"(eee.data);}"],{type:"application/javascript"})),n=new Worker(t);return n.workerURL=t,n}function r(){p=[],m=[],h=0,T=!1,g=!1,S=!1,b=null,f.leftchannel=p,f.rightchannel=m,f.numberOfAudioChannels=v,f.desiredSampRate=y,f.sampleRate=k,f.recordingLength=h,x={left:[],right:[],recordingLength:0}}function d(){u&&(u.onaudioprocess=null,u.disconnect(),u=null),w&&(w.disconnect(),w=null),r()}function s(e){if(!S){if(!1===n()&&(t.disableLogs||console.log("MediaStream seems stopped."),u.disconnect(),g=!1),!g)return void(w&&(w.disconnect(),w=null));T||(T=!0,t.onAudioProcessStarted&&t.onAudioProcessStarted(),t.initCallback&&t.initCallback());var i=e.inputBuffer.getChannelData(0),o=new Float32Array(i);if(p.push(o),2===v){var a=e.inputBuffer.getChannelData(1),r=new Float32Array(a);m.push(r)}h+=R,f.recordingLength=h,void 0!==t.timeSlice&&(x.recordingLength+=R,x.left.push(o),2===v&&x.right.push(r))}}function c(){g&&"function"==typeof t.ondataavailable&&void 0!==t.timeSlice&&(x.left.length?(i({desiredSampRate:y,sampleRate:k,numberOfAudioChannels:v,internalInterleavedLength:x.recordingLength,leftBuffers:x.left,rightBuffers:1===v?[]:x.right},function(e,n){var i=new Blob([n],{type:"audio/wav"});t.ondataavailable(i),setTimeout(c,t.timeSlice)}),x={left:[],right:[],recordingLength:0}):setTimeout(c,t.timeSlice))}if(!l(e,"audio").length)throw"Your stream has no audio tracks.";t=t||{};var u,f=this,p=[],m=[],g=!1,h=0,v=2,y=t.desiredSampRate;!0===t.leftChannel&&(v=1),1===t.numberOfAudioChannels&&(v=1),(!v||v<1)&&(v=2),t.disableLogs||console.log("StereoAudioRecorder is set to record number of channels: "+v),void 0===t.checkForInactiveTracks&&(t.checkForInactiveTracks=!0),this.record=function(){if(!1===n())throw"Please make sure MediaStream is active.";r(),T=S=!1,g=!0,void 0!==t.timeSlice&&c()},this.stop=function(e){e=e||function(){},g=!1,i({desiredSampRate:y,sampleRate:k,numberOfAudioChannels:v,internalInterleavedLength:h,leftBuffers:p,rightBuffers:1===v?[]:m,noWorker:t.noWorker},function(t,n){f.blob=new Blob([n],{type:"audio/wav"}),f.buffer=new ArrayBuffer(n.buffer.byteLength),f.view=n,f.sampleRate=y||k,f.bufferSize=R,f.length=h,T=!1,e&&e(f.blob)})},void 0===o.Storage&&(o.Storage={AudioContextConstructor:null,AudioContext:window.AudioContext||window.webkitAudioContext}),o.Storage.AudioContextConstructor&&"closed"!==o.Storage.AudioContextConstructor.state||(o.Storage.AudioContextConstructor=new o.Storage.AudioContext);var b=o.Storage.AudioContextConstructor,w=b.createMediaStreamSource(e),C=[0,256,512,1024,2048,4096,8192,16384],R=void 0===t.bufferSize?4096:t.bufferSize;if(-1===C.indexOf(R)&&(t.disableLogs||console.log("Legal values for buffer-size are "+JSON.stringify(C,null,"\t"))),b.createJavaScriptNode)u=b.createJavaScriptNode(R,v,v);else{if(!b.createScriptProcessor)throw"WebAudio API has no support on this browser.";u=b.createScriptProcessor(R,v,v)}w.connect(u),t.bufferSize||(R=u.bufferSize);var k=void 0!==t.sampleRate?t.sampleRate:b.sampleRate||44100;(k<22050||k>96e3)&&(t.disableLogs||console.log("sample-rate must be under range 22050 and 96000.")),t.disableLogs||t.desiredSampRate&&console.log("Desired sample-rate: "+t.desiredSampRate);var S=!1;this.pause=function(){S=!0},this.resume=function(){if(!1===n())throw"Please make sure MediaStream is active.";if(!g)return t.disableLogs||console.log("Seems recording has been restarted."),void this.record();S=!1},this.clearRecordedData=function(){t.checkForInactiveTracks=!1,g&&this.stop(d),d()},this.name="StereoAudioRecorder",this.toString=function(){return this.name};var T=!1;u.onaudioprocess=s,b.createMediaStreamDestination?u.connect(b.createMediaStreamDestination()):u.connect(b.destination),this.leftchannel=p,this.rightchannel=m,this.numberOfAudioChannels=v,this.desiredSampRate=y,this.sampleRate=k,f.recordingLength=h;var x={left:[],right:[],recordingLength:0}}/**
 ...
 */
function v(e,t){function n(){h.frames=[],f=!1,p=!1}function i(){var t=document.createElement("canvas"),n=t.getContext("2d");return t.width=e.width,t.height=e.height,n.drawImage(e,0,0),t}function o(){if(p)return m=(new Date).getTime(),setTimeout(o,500);if("canvas"===e.nodeName.toLowerCase()){var n=(new Date).getTime()-m;return m=(new Date).getTime(),h.frames.push({image:i(),duration:n}),void(f&&setTimeout(o,t.frameInterval))}html2canvas(e,{grabMouse:void 0===t.showMousePointer||t.showMousePointer,onrendered:function(e){var n=(new Date).getTime()-m;if(!n)return setTimeout(o,t.frameInterval);m=(new Date).getTime(),h.frames.push({image:e.toDataURL("image/webp",1),duration:n}),f&&setTimeout(o,t.frameInterval)}})}if("undefined"==typeof html2canvas)throw"Please link: https://www.webrtc-experiment.com/screenshot.js";t=t||{},t.frameInterval||(t.frameInterval=10);var a=!1;["captureStream","mozCaptureStream","webkitCaptureStream"].forEach(function(e){e in document.createElement("canvas")&&(a=!0)});var r=!(!window.webkitRTCPeerConnection&&!window.webkitGetUserMedia||!window.chrome),d=50,s=navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./);r&&s&&s[2]&&(d=parseInt(s[2],10)),r&&d<52&&(a=!1),t.useWhammyRecorder&&(a=!1);var c,u;if(a)if(t.disableLogs||console.log("Your browser supports both MediRecorder API and canvas.captureStream!"),e instanceof HTMLCanvasElement)c=e;else{if(!(e instanceof CanvasRenderingContext2D))throw"Please pass either HTMLCanvasElement or CanvasRenderingContext2D.";c=e.canvas}else navigator.mozGetUserMedia&&(t.disableLogs||console.error("Canvas recording is NOT supported in Firefox."));var f;this.record=function(){if(f=!0,a&&!t.useWhammyRecorder){var e;"captureStream"in c?e=c.captureStream(25):"mozCaptureStream"in c?e=c.mozCaptureStream(25):"webkitCaptureStream"in c&&(e=c.webkitCaptureStream(25));try{var n=new j;n.addTrack(l(e,"video")[0]),e=n}catch(e){}if(!e)throw"captureStream API are NOT available.";u=new g(e,{mimeType:t.mimeType||"video/webm"}),u.record()}else h.frames=[],m=(new Date).getTime(),o();t.initCallback&&t.initCallback()},this.getWebPImages=function(n){if("canvas"!==e.nodeName.toLowerCase())return void n();var i=h.frames.length;h.frames.forEach(function(e,n){var o=i-n;t.disableLogs||console.log(o+"/"+i+" frames remaining"),t.onEncodingCallback&&t.onEncodingCallback(o,i);var a=e.image.toDataURL("image/webp",1);h.frames[n].image=a}),t.disableLogs||console.log("Generating WebM"),n()},this.stop=function(e){f=!1;var n=this;if(a&&u)return void u.stop(e);this.getWebPImages(function(){h.compile(function(i){t.disableLogs||console.log("Recording finished!"),n.blob=i,n.blob.forEach&&(n.blob=new Blob([],{type:"video/webm"})),e&&e(n.blob),h.frames=[]})})};var p=!1;this.pause=function(){if(p=!0,u instanceof g)return void u.pause()},this.resume=function(){if(p=!1,u instanceof g)return void u.resume();f||this.record()},this.clearRecordedData=function(){f&&this.stop(n),n()},this.name="CanvasRecorder",this.toString=function(){return this.name};var m=(new Date).getTime(),h=new F.Video(100)}/**
 ...
 */
function y(e,t){function n(e){e=void 0!==e?e:10;var t=(new Date).getTime()-c;return t?d?(c=(new Date).getTime(),setTimeout(n,100)):(c=(new Date).getTime(),s.paused&&s.play(),p.drawImage(s,0,0,l.width,l.height),u.frames.push({duration:t,image:l.toDataURL("image/webp")}),void(r||setTimeout(n,e,e))):setTimeout(n,e,e)}function i(e){var t=-1,n=e.length;!function i(){if(++t===n)return void e.callback();setTimeout(function(){e.functionToLoop(i,t)},1)}()}function o(e,t,n,o,a){var r=document.createElement("canvas");r.width=l.width,r.height=l.height;var d=r.getContext("2d"),s=[],c=-1===t,u=t&&t>0&&t<=e.length?t:e.length,f={r:0,g:0,b:0},p=Math.sqrt(Math.pow(255,2)+Math.pow(255,2)+Math.pow(255,2)),m=n&&n>=0&&n<=1?n:0,g=o&&o>=0&&o<=1?o:0,h=!1;i({length:u,functionToLoop:function(t,n){var i,o,a,r=function(){!h&&a-i<=a*g||(c&&(h=!0),s.push(e[n])),t()};if(h)r();else{var u=new Image;u.onload=function(){d.drawImage(u,0,0,l.width,l.height);var e=d.getImageData(0,0,l.width,l.height);i=0,o=e.data.length,a=e.data.length/4;for(var t=0;t<o;t+=4){var n={r:e.data[t],g:e.data[t+1],b:e.data[t+2]};Math.sqrt(Math.pow(n.r-f.r,2)+Math.pow(n.g-f.g,2)+Math.pow(n.b-f.b,2))<=p*m&&i++}r()},u.src=e[n].image}},callback:function(){s=s.concat(e.slice(u)),s.length<=0&&s.push(e[e.length-1]),a(s)}})}function a(){u.frames=[],r=!0,d=!1}t=t||{},t.frameInterval||(t.frameInterval=10),t.disableLogs||console.log("Using frames-interval:",t.frameInterval),this.record=function(){t.width||(t.width=320),t.height||(t.height=240),t.video||(t.video={width:t.width,height:t.height}),t.canvas||(t.canvas={width:t.width,height:t.height}),l.width=t.canvas.width||320,l.height=t.canvas.height||240,p=l.getContext("2d"),t.video&&t.video instanceof HTMLVideoElement?(s=t.video.cloneNode(),t.initCallback&&t.initCallback()):(s=document.createElement("video"),f(e,s),s.onloadedmetadata=function(){t.initCallback&&t.initCallback()},s.width=t.video.width,s.height=t.video.height),s.muted=!0,s.play(),c=(new Date).getTime(),u=new F.Video,t.disableLogs||(console.log("canvas resolutions",l.width,"*",l.height),console.log("video width/height",s.width||l.width,"*",s.height||l.height)),n(t.frameInterval)};var r=!1;this.stop=function(e){e=e||function(){},r=!0;var n=this;setTimeout(function(){o(u.frames,-1,null,null,function(i){u.frames=i,t.advertisement&&t.advertisement.length&&(u.frames=t.advertisement.concat(u.frames)),u.compile(function(t){n.blob=t,n.blob.forEach&&(n.blob=new Blob([],{type:"video/webm"})),e&&e(n.blob)})})},10)};var d=!1;this.pause=function(){d=!0},this.resume=function(){d=!1,r&&this.record()},this.clearRecordedData=function(){r||this.stop(a),a()},this.name="WhammyRecorder",this.toString=function(){return this.name};var s,c,u,l=document.createElement("canvas"),p=l.getContext("2d")}/**
 ...
 */
function b(e,t){function n(){m&&(m.stream().bin=[])}if("undefined"==typeof GIFEncoder){var i=document.createElement("script");i.src="https://www.webrtc-experiment.com/gif-recorder.js",(document.body||document.documentElement).appendChild(i)}t=t||{};var o=e instanceof CanvasRenderingContext2D||e instanceof HTMLCanvasElement;this.record=function(){function e(n){if(!0!==h.clearedRecordedData){if(a)return setTimeout(function(){e(n)},100);g=x(e),void 0===typeof p&&(p=n),n-p<90||(!o&&c.paused&&c.play(),o||d.drawImage(c,0,0,r.width,r.height),t.onGifPreview&&t.onGifPreview(r.toDataURL("image/png")),m.addFrame(d),p=n)}}return"undefined"==typeof GIFEncoder?void setTimeout(h.record,1e3):s?(o||(t.width||(t.width=c.offsetWidth||320),t.height||(t.height=c.offsetHeight||240),t.video||(t.video={width:t.width,height:t.height}),t.canvas||(t.canvas={width:t.width,height:t.height}),r.width=t.canvas.width||320,r.height=t.canvas.height||240,c.width=t.video.width||320,c.height=t.video.height||240),m=new GIFEncoder,m.setRepeat(0),m.setDelay(t.frameRate||200),m.setQuality(t.quality||10),m.start(),"function"==typeof t.onGifRecordingStarted&&t.onGifRecordingStarted(),u=Date.now(),g=x(e),void(t.initCallback&&t.initCallback())):void setTimeout(h.record,1e3)},this.stop=function(e){e=e||function(){},g&&D(g),l=Date.now(),this.blob=new Blob([new Uint8Array(m.stream().bin)],{type:"image/gif"}),e(this.blob),m.stream().bin=[]};var a=!1;this.pause=function(){a=!0},this.resume=function(){a=!1},this.clearRecordedData=function(){h.clearedRecordedData=!0,n()},this.name="GifRecorder",this.toString=function(){return this.name};var r=document.createElement("canvas"),d=r.getContext("2d");o&&(e instanceof CanvasRenderingContext2D?(d=e,r=d.canvas):e instanceof HTMLCanvasElement&&(d=e.getContext("2d"),r=e));var s=!0;if(!o){var c=document.createElement("video");c.muted=!0,c.autoplay=!0,c.playsInline=!0,s=!1,c.onloadedmetadata=function(){s=!0},f(e,c),c.play()}var u,l,p,m,g=null,h=this}function w(e,t){function i(e,t){"srcObject"in t?t.srcObject=e:"mozSrcObject"in t?t.mozSrcObject=e:t.srcObject=e}function a(){if(!p){var e=f.length,t=!1,n=[];if(f.forEach(function(e){e.stream||(e.stream={}),e.stream.fullcanvas?t=e:n.push(e)}),t)m.width=t.stream.width,m.height=t.stream.height;else if(n.length){m.width=e>1?2*n[0].width:n[0].width;var i=1;3!==e&&4!==e||(i=2),5!==e&&6!==e||(i=3),7!==e&&8!==e||(i=4),9!==e&&10!==e||(i=5),m.height=n[0].height*i}else m.width=h.width||360,m.height=h.height||240;t&&t instanceof HTMLVideoElement&&r(t),n.forEach(function(e,t){r(e,t)}),setTimeout(a,h.frameInterval)}}function r(e,t){if(!p){var n=0,i=0,o=e.width,a=e.height;1===t&&(n=e.width),2===t&&(i=e.height),3===t&&(n=e.width,i=e.height),4===t&&(i=2*e.height),5===t&&(n=e.width,i=2*e.height),6===t&&(i=3*e.height),7===t&&(n=e.width,i=3*e.height),void 0!==e.stream.left&&(n=e.stream.left),void 0!==e.stream.top&&(i=e.stream.top),void 0!==e.stream.width&&(o=e.stream.width),void 0!==e.stream.height&&(a=e.stream.height),g.drawImage(e,n,i,o,a),"function"==typeof e.stream.onRender&&e.stream.onRender(g,n,i,o,a,t)}}function d(){p=!1;var t=s(),n=c();n&&n.getTracks().filter(function(e){return"audio"===e.kind}).forEach(function(e){t.addTrack(e)});var i;return e.forEach(function(e){e.fullcanvas&&(i=!0)}),t}function s(){l();var e;"captureStream"in m?e=m.captureStream():"mozCaptureStream"in m?e=m.mozCaptureStream():h.disableLogs||console.error("Upgrade to latest Chrome or otherwise enable this flag: chrome://flags/#enable-experimental-web-platform-features");var t=new b;return e.getTracks().filter(function(e){return"video"===e.kind}).forEach(function(e){t.addTrack(e)}),m.stream=t,t}function c(){w.AudioContextConstructor||(w.AudioContextConstructor=new w.AudioContext),h.audioContext=w.AudioContextConstructor,h.audioSources=[],!0===h.useGainNode&&(h.gainNode=h.audioContext.createGain(),h.gainNode.connect(h.audioContext.destination),h.gainNode.gain.value=0);var t=0;if(e.forEach(function(e){if(e.getTracks().filter(function(e){return"audio"===e.kind}).length){t++;var n=h.audioContext.createMediaStreamSource(e);!0===h.useGainNode&&n.connect(h.gainNode),h.audioSources.push(n)}}),t)return h.audioDestination=h.audioContext.createMediaStreamDestination(),h.audioSources.forEach(function(e){e.connect(h.audioDestination)}),h.audioDestination.stream}function u(e){var n=document.createElement("video");return i(e,n),n.className=t,n.muted=!0,n.volume=0,n.width=e.width||h.width||360,n.height=e.height||h.height||240,n.play(),n}function l(t){f=[],t=t||e,t.forEach(function(e){if(e.getTracks().filter(function(e){return"video"===e.kind}).length){var t=u(e);t.stream=e,f.push(t)}})}!function(e){void 0===o&&e&&"undefined"==typeof window&&void 0!==n&&(n.navigator={userAgent:"Fake/5.0 (FakeOS) AppleWebKit/123 (KHTML, like Gecko) Fake/12.3.4567.89 Fake/123.45",getUserMedia:function(){}},n.console||(n.console={}),void 0!==n.console.log&&void 0!==n.console.error||(n.console.error=n.console.log=n.console.log||function(){console.log(arguments)}),"undefined"==typeof document&&(e.document={documentElement:{appendChild:function(){return""}}},document.createElement=document.captureStream=document.mozCaptureStream=function(){var e={getContext:function(){return e},play:function(){},pause:function(){},drawImage:function(){},toDataURL:function(){return""},style:{}};return e},e.HTMLVideoElement=function(){}),"undefined"==typeof location&&(e.location={protocol:"file:",href:"",hash:""}),"undefined"==typeof screen&&(e.screen={width:0,height:0}),void 0===y&&(e.URL={createObjectURL:function(){return""},revokeObjectURL:function(){return""}}),e.window=n)}(void 0!==n?n:null),t=t||"multi-streams-mixer";var f=[],p=!1,m=document.createElement("canvas"),g=m.getContext("2d");m.style.opacity=0,m.style.position="absolute",m.style.zIndex=-1,m.style.top="-1000em",m.style.left="-1000em",m.className=t,(document.body||document.documentElement).appendChild(m),this.disableLogs=!1,this.frameInterval=10,this.width=360,this.height=240,this.useGainNode=!0;var h=this,v=window.AudioContext;void 0===v&&("undefined"!=typeof webkitAudioContext&&(v=webkitAudioContext),"undefined"!=typeof mozAudioContext&&(v=mozAudioContext));var y=window.URL;void 0===y&&"undefined"!=typeof webkitURL&&(y=webkitURL),"undefined"!=typeof navigator&&void 0===navigator.getUserMedia&&(void 0!==navigator.webkitGetUserMedia&&(navigator.getUserMedia=navigator.webkitGetUserMedia),void 0!==navigator.mozGetUserMedia&&(navigator.getUserMedia=navigator.mozGetUserMedia));var b=window.MediaStream;void 0===b&&"undefined"!=typeof webkitMediaStream&&(b=webkitMediaStream),void 0!==b&&void 0===b.prototype.stop&&(b.prototype.stop=function(){this.getTracks().forEach(function(e){e.stop()})});var w={};void 0!==v?w.AudioContext=v:"undefined"!=typeof webkitAudioContext&&(w.AudioContext=webkitAudioContext),this.startDrawingFrames=function(){a()},this.appendStreams=function(t){if(!t)throw"First parameter is required.";t instanceof Array||(t=[t]),t.forEach(function(t){var n=new b;if(t.getTracks().filter(function(e){return"video"===e.kind}).length){var i=u(t);i.stream=t,f.push(i),n.addTrack(t.getTracks().filter(function(e){return"video"===e.kind})[0])}if(t.getTracks().filter(function(e){return"audio"===e.kind}).length){var o=h.audioContext.createMediaStreamSource(t);h.audioDestination=h.audioContext.createMediaStreamDestination(),o.connect(h.audioDestination),n.addTrack(h.audioDestination.stream.getTracks().filter(function(e){return"audio"===e.kind})[0])}e.push(n)})},this.releaseStreams=function(){f=[],p=!0,h.gainNode&&(h.gainNode.disconnect(),h.gainNode=null),h.audioSources.length&&(h.audioSources.forEach(function(e){e.disconnect()}),h.audioSources=[]),h.audioDestination&&(h.audioDestination.disconnect(),h.audioDestination=null),h.audioContext&&h.audioContext.close(),h.audioContext=null,g.clearRect(0,0,m.width,m.height),m.stream&&(m.stream.stop(),m.stream=null)},this.resetVideoStreams=function(e){!e||e instanceof Array||(e=[e]),l(e)},this.name="MultiStreamsMixer",this.toString=function(){return this.name},this.getMixedStream=d}/**
 ...
 * @see {@link https://github.com/muaz-khan/RecordRTC|RecordRTC Source Code}
 */
var E={};void 0!==M?E.AudioContext=M:"undefined"!=typeof webkitAudioContext&&(E.AudioContext=webkitAudioContext),void 0!==o&&(o.Storage=E),void 0!==o&&(o.MediaStreamRecorder=g),void 0!==o&&(o.StereoAudioRecorder=h),void 0!==o&&(o.CanvasRecorder=v),void 0!==o&&(o.WhammyRecorder=y);/**
