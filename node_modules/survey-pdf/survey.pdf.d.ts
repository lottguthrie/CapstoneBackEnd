/*Type definitions for SurveyJS PDF library v1.9.0
...
export declare class SurveyHelper {
    ...
    static chooseHtmlFont(controller: DocController, renderAs: IHTMLRenderType): string;
...
export declare class FlatQuestion implements IFlatQuestion {
    ...
    static readonly CONTENT_INDENT_SCALE: number;
...
export declare class RankingItemBrick extends PdfBrick {
    ...
    protected question: QuestionRankingModel;
    constructor(question: IQuestion, controller: DocController, rect: IRect, number: string);
    renderInteractive(): Promise<void>;
}
