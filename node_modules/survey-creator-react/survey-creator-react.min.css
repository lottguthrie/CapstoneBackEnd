/*!
 * SurveyJS Creator React v1.9.1-beta.1
 * (c) 2015-2021 Devsoft Baltic OÜ - http://surveyjs.io/
 * Github: https://github.com/surveyjs/survey-creator
 * License: https://surveyjs.io/Licenses#SurveyCreator
 */
/*!
 * SurveyJS Creator v1.9.1-beta.1
 * (c) 2015-2021 Devsoft Baltic OÜ - http://surveyjs.io/
 * Github: https://github.com/surveyjs/survey-creator
 * License: https://surveyjs.io/Licenses#SurveyCreator
 */
...
.svc-creator {
  ...
  .svc-creator * {
    ...
    scrollbar-color: var(--primary-light, rgba(25, 179, 148, 0.1)) var(--background-dim, #f3f3f3); }
...
survey-creator .sv-action-bar-item:not(button):focus,
survey-creator *:not(button):focus,
survey-creator .svc-page__question-type-selector:focus,
.svc-creator .sv-action-bar-item:not(button):focus,
.svc-creator *:not(button):focus,
.svc-creator .svc-page__question-type-selector:focus,
.sv-popup .sv-action-bar-item:not(button):focus,
.sv-popup *:not(button):focus,
.sv-popup .svc-page__question-type-selector:focus {
  outline: 1px dotted var(--primary, #19b394); }

survey-creator button.sv-action-bar-item:focus,
survey-creator .sv-button-group__item:focus-within,
.svc-creator button.sv-action-bar-item:focus,
.svc-creator .sv-button-group__item:focus-within,
.sv-popup button.sv-action-bar-item:focus,
.sv-popup .sv-button-group__item:focus-within {
  outline: 1px dotted var(--primary, #19b394); }

survey-creator .sd-table__cell--header .svc-matrix-cell,
.svc-creator .sd-table__cell--header .svc-matrix-cell,
.sv-popup .sd-table__cell--header .svc-matrix-cell {
  outline: none; }
...
.sd-rating .svc-string-editor:focus-within .svc-string-editor__border {
  display: none; }
...
.sd-table__cell:first-child .svc-string-editor {
  margin-left: calc(1 * var(--base-unit, 8px)); }

survey-creator .svc-string-editor *:not(button):focus,
.svc-creator .svc-string-editor *:not(button):focus,
.sv-popup .svc-string-editor *:not(button):focus {
  outline: none; }
...
.svc-test-tab__content-actions {
  ...
  .svc-test-tab__content-actions .svc-page-selector {
    max-width: 50%; }
    .svc-test-tab__content-actions .svc-page-selector .sv-action-bar-item {
      width: 100%; }
...
.sl-table__row:hover #remove-row .sv-action-bar-item,
.sl-table__row #remove-row:focus-within .sv-action-bar-item {
  padding: calc(0.25 * var(--base-unit, 8px));
  border: none; }

.sl-table__row:hover #remove-row .sv-action-bar-item__icon use,
.sl-table__row #remove-row:focus-within .sv-action-bar-item__icon use {
  fill: var(--red, #e60a3e);
  display: block; }

.sl-table__row.sl-table__row--additional .sl-table__cell {
...
.sl-panel__footer {
  padding-left: 0; }
  .sl-panel__footer.sv-action-bar {
    width: 100%; }
  .sl-panel__footer #saveDetailPanel {
    width: 100%; }
  .sl-panel__footer .sv-action__content {
    width: 100%; }
  .sl-panel__footer button.sl-panel__done-button {
    width: 100%;
    margin-bottom: calc(10 * var(--base-unit, 8px));
    background-color: var(--green-light, rgba(25, 179, 148, 0.1));
    color: var(--green, #19b394);
    font-family: "Open Sans", "Helvetica Neue", Helvetica, Arial, sans-serif;
    font-size: calc(2 * var(--base-unit, 8px));
    border-radius: calc(12.5 * var(--base-unit, 8px));
    display: flex;
    ...
    text-align: center;
    user-select: none; }
  .sl-panel__footer button:hover {
    background-color: var(--green, #19b394);
    color: white; }
  .sl-panel__footer .sv-action-bar-item__title {
    display: flex;
    align-items: center;
    flex-grow: 1;
    justify-content: center;
...
.svc-logic-question-value {
  padding-right: calc(5 * var(--base-unit, 8px)) !important; }

.sl-panel-wrapper--in-row {
  display: flex;
  align-items: flex-start; }
...
.svc-logic-paneldynamic .sl-panel {
...
.svc-logic-panel-element .sd-row {
  margin-top: 0; }
...
.svc-logic-operator.svc-logic-operator--operator {
  background-color: var(--secondary-light, rgba(255, 152, 20, 0.25)); }
...
.svc-question-wrapper .sv-title-actions__title {
  max-width: none; }
...
.svc-logic-tab__content.svc-logic-tab__empty {
  ...
  .svc-logic-tab__content.svc-logic-tab__empty .svc-logic-tab__content-action {
    width: calc(40 * var(--base-unit, 8px));
...
.svc-logic-tab__content .svc-text {
...
.svc-logic-paneldynamic {
  ...
  .svc-logic-paneldynamic .sd-question__content {
    margin-top: 0; }
  .svc-logic-paneldynamic .sd-row__question {
    margin-top: 0; }
...
.svc-tab-designer .sd-container-modern {
  ...
  .svc-tab-designer .sd-container-modern.sd-container-modern--static {
    max-width: calc(102 * var(--base-unit, 8px)); }
...
.svc-creator--mobile .sd-question__content .sd-selectbase__column {
  max-width: initial;
  display: block; }
  .svc-creator--mobile .sd-question__content .sd-selectbase__column .svc-item-value-wrapper {
...
.svc-page-navigator__navigator-icon {
  display: block;
  height: calc(2.75 * var(--base-unit, 8px));
  width: calc(2.75 * var(--base-unit, 8px));
  padding: 11px;
  border-radius: 50%;
  cursor: pointer; }
...
survey-creator .svc-page-navigator__selector:hover, survey-creator .svc-page-navigator__selector:focus, .svc-creator .svc-page-navigator__selector:hover, .svc-creator .svc-page-navigator__selector:focus {
  outline: none; }
  survey-creator .svc-page-navigator__selector:hover .svc-page-navigator__navigator-icon, survey-creator .svc-page-navigator__selector:focus .svc-page-navigator__navigator-icon, .svc-creator .svc-page-navigator__selector:hover .svc-page-navigator__navigator-icon, .svc-creator .svc-page-navigator__selector:focus .svc-page-navigator__navigator-icon {
    background-color: var(--primary-light, rgba(25, 179, 148, 0.1)); }
    survey-creator .svc-page-navigator__selector:hover .svc-page-navigator__navigator-icon use, survey-creator .svc-page-navigator__selector:focus .svc-page-navigator__navigator-icon use, .svc-creator .svc-page-navigator__selector:hover .svc-page-navigator__navigator-icon use, .svc-creator .svc-page-navigator__selector:focus .svc-page-navigator__navigator-icon use {
      fill: var(--primary, #19b394); }
...
.svc-tab-designer--with-page-navigator {
  padding-right: calc(6.5 * var(--base-unit, 8px)); }
...
.svc-creator__toolbox--right .svc-tab-designer--with-page-navigator {
  padding-right: 0;
  padding-left: calc(6.5 * var(--base-unit, 8px)); }
...
.svc-page__content {
  position: relative;
  padding: calc(1 * var(--base-unit, 8px)) calc(1 * var(--base-unit, 8px)) calc(3 * var(--base-unit, 8px));
  box-sizing: border-box;
  width: 100%; }
...
.svc-page__content-actions {
  ...
  right: 0; }
  .svc-page__content-actions .sv-action-bar {
    padding: 0 calc(1 * var(--base-unit, 8px)); }
    .svc-page__content-actions .sv-action-bar .sv-action-bar-item {
      font-size: calc(1.5 * var(--base-unit, 8px));
      font-weight: 600;
      line-height: calc(2 * var(--base-unit, 8px));
      align-items: center;
      height: calc(4 * var(--base-unit, 8px)); }
    .svc-page__content-actions .sv-action-bar .sv-action-bar-separator {
      margin-right: calc(1 * var(--base-unit, 8px)); }
    .svc-page__content-actions .sv-action-bar .sv-action:not(:last-child) > .sv-action__content {
      padding-right: calc(1 * var(--base-unit, 8px)); }
...
.svc-hovered {
  ...
  .svc-hovered.svc-page__content--selected {
    outline: 2px solid var(--secondary, #ff9814);
    background: var(--secondary-back-light, rgba(255, 152, 20, 0.1)); }
  ...
  .svc-question__adorner .sv-action-bar {
    ...
    .svc-question__adorner .sv-action-bar .sv-action:not(:first-child) .sv-action-bar-item {
      ...
      .svc-question__adorner .sv-action-bar .sv-action:not(:first-child) .sv-action-bar-item:active {
        opacity: 0.5;
        background-color: var(--background-dim, #f3f3f3); }
      .svc-question__adorner .sv-action-bar .sv-action:not(:first-child) .sv-action-bar-item .sv-action-bar-item__title--with-icon {
...
.svc-panel__placeholder_frame {
  ...
  width: 100%;
  height: calc(23 * var(--base-unit, 8px));
  box-sizing: border-box; }
...
.svc-question__content-actions {
  ...
  width: calc(100% - 7 * var(--base-unit, 8px));
  left: calc(4 * var(--base-unit, 8px)); }
  .svc-question__content-actions .sv-action-bar-item {
    font-size: calc(1.5 * var(--base-unit, 8px));
    font-weight: 600;
    line-height: calc(2 * var(--base-unit, 8px));
    align-items: center;
    height: calc(4 * var(--base-unit, 8px)); }
  .svc-question__content-actions .sv-action-bar-separator {
    margin-right: calc(1 * var(--base-unit, 8px)); }
  .svc-question__content-actions .sv-action:not(:last-child) > .sv-action__content {
    padding-right: calc(1 * var(--base-unit, 8px)); }
  .svc-question__content-actions .sv-action--first {
    min-width: calc(13 * var(--base-unit, 8px)); }
    .svc-question__content-actions .sv-action--first .sv-action-bar-item {
      max-width: 100%; }
      .svc-question__content-actions .sv-action--first .sv-action-bar-item .sv-action-bar-item__title {
        overflow: hidden;
        text-overflow: ellipsis;
        white-space: nowrap;
        display: inline-block;
...
.svc-creator .svc-page .svc-hovered > .svc-question__content {
  outline: 2px solid var(--secondary-light, rgba(255, 152, 20, 0.25)); }

.svc-creator .svc-page .svc-question__content--selected,
.svc-creator .svc-page .svc-hovered > .svc-question__content--selected {
  outline: 2px solid var(--secondary, #ff9814);
  box-shadow: initial; }
  .svc-creator .svc-page .svc-question__content--selected > .svc-question__content-actions,
  .svc-creator .svc-page .svc-hovered > .svc-question__content--selected > .svc-question__content-actions {
    display: block; }
...
.svc-hovered > .svc-question__content--drag-over-inside {
  ...
  background: var(--primary-light, rgba(25, 179, 148, 0.1)); }
  .svc-question__content--drag-over-inside > .svc-question__content-actions,
  .svc-hovered > .svc-question__content--drag-over-inside > .svc-question__content-actions {
    display: block; }
...
.sd-row--multiple .svc-hovered > .svc-question__content:not(.svc-question__content--selected) {
  ...
  outline: 1px solid var(--secondary-light, rgba(255, 152, 20, 0.25)); }
...
.svc-rating-question-controls {
  position: absolute;
  bottom: calc(9 * var(--base-unit, 8px));
  left: calc(5 * var(--base-unit, 8px));
  display: none; }

.svc-question__content--selected .sd-rating {
  margin-left: calc(9 * var(--base-unit, 8px));
  width: calc(100% - 9 * var(--base-unit, 8px)); }

.svc-question__content--selected .svc-rating-question-controls {
  display: block;
...
sv-svg-icon.svc-item-value-controls__button {
  ...
  height: calc(2 * var(--base-unit, 8px));
  box-sizing: content-box; }
  .svc-item-value-controls__button > span .sv-svg-icon,
  sv-svg-icon.svc-item-value-controls__button .sv-svg-icon {
    display: block; }
...
.svc-item-value-controls__drag {
  ...
  .svc-item-value-controls__drag use {
    fill: var(--foreground-light, #909090); }
  .svc-item-value-controls__drag:hover use {
    fill: var(--primary, #19b394); }
...
.svc-item-value-controls__add:hover {
  background-color: var(--primary-light, rgba(25, 179, 148, 0.1)); }
  .svc-item-value-controls__add:hover use {
    fill: var(--primary, #19b394); }

.svc-item-value-controls__remove:hover {
  background-color: var(--red-light, rgba(230, 10, 62, 0.1)); }
  .svc-item-value-controls__remove:hover use {
    fill: var(--red, #e60a3e); }
...
.svc-item-value--new .svc-item-value__item {
  opacity: 0.5; }
...
.svc-question__content--selected .svc-image-item-value-controls {
  display: block; }
...
.svc-image-item-value-controls__remove:hover use {
  fill: var(--red, #e60a3e); }

.svc-image-item-value-controls__add:hover {
  background-color: var(--primary-light, rgba(25, 179, 148, 0.1)); }
  .svc-image-item-value-controls__add:hover use {
    fill: var(--primary, #19b394); }
...
.svc-question__content--selected .svc-image-item-value-wrapper:hover .svc-image-item__drag-element {
  display: block; }
...
.svc-question__content .sd-table td:empty, .svc-question__content .sd-table th:empty {
  width: initial; }
...
.nav-link {
  border-radius: 0;
  border-top-left-radius: calc(0.25 * var(--base-unit, 8px));
  border-top-right-radius: calc(0.25 * var(--base-unit, 8px));
  padding: 0.5em 1em;
  text-align: center; }
  .nav-link.active {
    border: calc(0.125 * var(--base-unit, 8px)) solid var(--border, #d6d6d6);
...
.svc-tabbed-menu-item {
  padding: 0px calc(3 * var(--base-unit, 8px));
  line-height: calc(8 * var(--base-unit, 8px));
  box-sizing: border-box;
  cursor: pointer; }
...
.svc-creator__toolbox--right .svc-toolbox__item:focus .svc-toolbox__item-banner {
  ...
  padding-left: calc(2 * var(--base-unit, 8px));
  margin-left: 0;
  margin-right: calc(-1.5 * var(--base-unit, 8px)); }
...
.svc-question__content--selected .svc-question__dropdown-choices,
.svc-question__content--selected-no-border .svc-question__dropdown-choices {
  display: block; }
...
.svc-toolbox__category-header__controls {
  position: absolute;
  right: calc(1.2 * var(--base-unit, 8px));
  top: calc(1.2 * var(--base-unit, 8px));
  display: none; }
...
.svc-side-bar__container {
  ...
  font-family: "Open Sans", "Helvetica Neue", Helvetica, Arial, sans-serif;
  min-width: 370px;
  max-width: calc(118 * var(--base-unit, 8px));
  width: 450px;
  height: 100%; }
...
.svc-side-bar__container-actions {
  ...
  .svc-side-bar__container-actions .sv-action-bar {
    padding: 0; }
    .svc-side-bar__container-actions .sv-action-bar > .sv-action.sv-dots.sv-action--hidden {
      margin-right: calc(-2 * var(--base-unit, 8px)); }
...
.svc-full-container.svc-creator__side-bar--left {
  ...
  .svc-full-container.svc-creator__side-bar--left .svc-side-bar__container-header .sv-action-bar {
    flex-direction: row-reverse; }
  .svc-full-container.svc-creator__side-bar--left .sv-action--last {
...
.spg-question-link__set-button {
  font-weight: 600;
  cursor: pointer; }

.spg-question-link__clear-button {
  margin-left: calc(4 * var(--base-unit, 8px));
  color: var(--red, #e60a3e);
  font-weight: 600;
  cursor: pointer; }
...
.spg-dropdown {
  background-image: url("data:image/svg+xml,%3Csvg width='10' height='5' viewBox='0 0 10 5' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M5 5L10 0H0L5 5Z' fill='%23909090'/%3E%3C/svg%3E%0A");
  background-repeat: no-repeat, repeat;
  background-position: right calc(2.5 * var(--base-unit, 8px)) top 50%, 0 0;
...
.spg-panel__title--expandable:hover {
  background-color: var(--background-dim, #f3f3f3);
  color: var(--foreground-light, #909090);
  font-weight: 400; }

.spg-panel__title--expanded,
.spg-panel__title--expanded:hover {
  color: var(--foreground, #161616);
  font-weight: 600;
  background-color: var(--background, #fff); }
...
.spg-checkbox--checked .spg-checkbox__rectangle:after {
  ...
  background-image: url("data:image/svg+xml,%3Csvg width='16' height='11' viewBox='0 0 16 11' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M6 10.8L0.599998 5.4L2 4L6 8L14 0L15.4 1.4L6 10.8Z' fill='%2319B394'/%3E%3C/svg%3E%0A"); }

.spg-checkbox--disabled.spg-checkbox--checked .spg-checkbox__rectangle:after {
  background-image: url("data:image/svg+xml,%3Csvg width='16' height='11' viewBox='0 0 16 11' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M6 10.8L0.599998 5.4L2 4L6 8L14 0L15.4 1.4L6 10.8Z' fill='%23D6D6D6'/%3E%3C/svg%3E%0A"); }
...
.spg-table tr:not(:last-child) {
  box-shadow: 0px 1px 0px var(--border, #d6d6d6); }
...
.spg-table__cell--actions .sv-action-bar {
  padding: 0;
  opacity: 0.5; }
...
.spg-table__cell--header {
  font-size: calc(1.5 * var(--base-unit, 8px));
  font-weight: 600;
  padding: calc(1 * var(--base-unit, 8px)) 0 calc(1 * var(--base-unit, 8px)) calc(2 * var(--base-unit, 8px));
  color: var(--foreground-light, #909090);
  line-height: calc(2 * var(--base-unit, 8px));
  box-shadow: 0px 1px 0px var(--border, #d6d6d6);
  background: var(--background-dim, #f3f3f3);
...
.spg-root-modern .sv-action-bar {
  padding-right: calc(0.5 * var(--base-unit, 8px)); }

.spg-root-modern .sv-action:not(.sv-action--hidden):not(:last-of-type) > .sv-action__content {
  padding-right: 0; }
